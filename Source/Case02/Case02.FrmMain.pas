...
procedure TCase02_FrmMain.Edit1KeyDown(Sender: TObject; var Key: word; Shift: TShiftState);
begin
...
procedure TCase02_FrmMain.FormClose(Sender: TObject; var CloseAction: TCloseAction);
begin
  _Commodity.Free;
end;
